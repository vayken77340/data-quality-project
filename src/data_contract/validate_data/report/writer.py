"""Wraps the three report formats so the runner has a single call."""
...
def write_all(
    ...
    """Emit XLSX + JSON + Markdown into `out_dir`. Returns the path of each."""
    ...
    return {"xlsx": xlsx_path, "json": json_path, "markdown": md_path}
